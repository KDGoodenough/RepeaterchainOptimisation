...
colors = ['mediumseagreen', 'goldenrod', 'orchid','orangered', 'cornflowerblue', 'chocolate']*3
...
lines1, = axes.plot([-1], [0], '-',  alpha=1, linewidth = 2, color = 'k')
lines2, = axes.plot([-1], [0], ':', alpha=1, linewidth = 2, color = 'k')
...
#leg1 = axes.legend(lines, ['Without bisection heuristic', 'With bisection heuristic'], bbox_to_anchor=(0.5, 1.165),
#          ncol=3,loc = 'center', borderaxespad=0., prop={'size': 12.5}, handlelength=2, handletextpad=0.35)

#leg1 = axes.legend(lines, ['Five nodes', 'Ten nodes'], bbox_to_anchor=(0.5, 1.165),
#          ncol=3,loc = 'center', borderaxespad=0., prop={'size': 12.5}, handlelength=2, handletextpad=0.35)
...
axes.legend(handles=patches, prop={'size': 12.5},
        ncol=1,loc = 'best', handletextpad=0.85, handlelength=3.4)
...
#plt.show()
name = 'Notes/figs/300 km, 4 rptrs IP eps dist and swap comp2.pdf'
